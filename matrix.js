...
function addMatrices(matrix1, matrix2){ 
    ...
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        document.getElementById('matrix3').innerHTML = 'Matrices must have the same dimensions to be added.';
        return;
    }
...
const subtractMatrices = function (matrix1, matrix2) { 
    ...
    let result = [];
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        document.getElementById('matrix3').innerHTML = 'Matrices must have the same dimensions to be subtracted.';
        return;
    }
    for (let i = 0; i < matrix1.length; i++) {
        let row = [];
